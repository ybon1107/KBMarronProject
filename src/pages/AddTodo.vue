  ...
  <div class="row">
    <div class="col">
      <div class="form-group">
        ...
        <label> <input type="radio" v-model="todoItem.transaction" value="수입" /> 수입 </label>
        <label> <input type="radio" v-model="todoItem.transaction" value="지출" /> 지출 </label>
        <label> <input type="radio" v-model="todoItem.transaction" value="이체" /> 이체 </label>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="amount" v-model="todoItem.amount" />
      </div>
      <div class="form-group">
...
const todoItem = reactive({ date: '', memo: '', asset: '', transaction: '', amount: '', type: '' });
