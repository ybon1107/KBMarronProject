<template>
    <div class="row">
        <div class="col">
            ...
            <!-- 테이블 및 기타 컨텐츠 -->
            <button @click="deleteSelectedTodos" class="btn btn-danger mb-2">
                선택 행 삭제
            </button>
            <table class="table">
                <thead>
                        ...
                        <th colspan="6" style="padding: 10px">
                            ...
                            >
                                ...
                                <span
                                    ...
                                    {{
                                        formatAmount(
                                            filteredTotalExpenseIncomeDiff
                                        )
                                    }}
                                    원</span
                                >
    ...
    const filteredItems = todoList.value.filter((todoItem) => {
        ...
        return (
            itemDate.getFullYear() ===
                new Date(selectedMonth.value).getFullYear() &&
    ...
    try {
        ...
        responses.forEach((response, index) => {
            if (response.status === 200) {
                ...
                const todoIndex = states.todoList.findIndex(
                    (todo) => todo.id === id
                );
